<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateCarros.aspx.cs" Inherits="TesteAccessBrasil2.Content.Views.update.UpdateCarros" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Atualizar" runat="server" Text="Atualizar " OnClick="AtualizarBtn" />
        </div>
    </form>
</body>
</html>
